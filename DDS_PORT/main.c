...
const uint8_t *MENU[] = { MN000,	//
		MN100,	//menu 1 string
		MN200,	//menu 2 string
		MN300,	//menu 3 string
		MN400,	//menu 4 string
		MN500, MN600, MN700, MN800 };
//various LCD strings
...
const uint8_t sinewave[] __attribute__ ((section (".MySection1"))) = //sine 256 values
		{ 0x80, 0x83, 0x86, 0x89, 0x8c, 0x8f, 0x92, 0x95, 0x98, 0x9c, 0x9f,
				...
				0xb3, 0xb0, 0xae, 0xab, 0xa8, 0xa5, 0xa2, 0x9f, 0x9c, 0x98,
				0x95, 0x92, 0x8f, 0x8c, 0x89, 0x86, 0x83, 0x80, 0x7c, 0x79,
				0x76, 0x73, 0x70, 0x6d, 0x6a, 0x67, 0x63, 0x60, 0x5d, 0x5a,
				...
				0x10, 0x0f, 0x0d, 0x0c, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05,
				...
				0x0d, 0x0f, 0x10, 0x12, 0x13, 0x15, 0x17, 0x19, 0x1b, 0x1d,
				0x1f, 0x21, 0x23, 0x25, 0x27, 0x2a, 0x2c, 0x2e, 0x31, 0x33,
				0x36, 0x38, 0x3b, 0x3e, 0x40, 0x43, 0x46, 0x49, 0x4c, 0x4f,
				0x51, 0x54, 0x57, 0x5a, 0x5d, 0x60, 0x63, 0x67, 0x6a, 0x6d,
...
const uint8_t trianglewave[] __attribute__ ((section (".MySection5"))) = //triangle wave
		{ 0x00, 0x02, 0x04, 0x06, 0x08, 0x0a, 0x0c, 0x0e, 0x10, 0x12, 0x14,
				...
				 };
const uint8_t ECG[] __attribute__ ((section (".MySection6"))) = //ECG wave
		{ 73, 74, 75, 75, 74, 73, 73, 73, 73, 72, 71, 69, 68, 67, 67, 67, 68,
				68, 67, 65, 62, 61, 59, 57, 56, 55, 55, 54, 54, 54, 55, 55, 55,
				55, 55, 55, 54, 53, 51, 50, 49, 49, 52, 61, 77, 101, 132, 169,
				207, 238, 255, 254, 234, 198, 154, 109, 68, 37, 17, 5, 0, 1, 6,
				13, 20, 28, 36, 45, 52, 57, 61, 64, 65, 66, 67, 68, 68, 69, 70,
				71, 71, 71, 71, 71, 71, 71, 71, 72, 72, 72, 73, 73, 74, 75, 75,
				76, 77, 78, 79, 80, 81, 82, 83, 84, 86, 88, 91, 93, 96, 98, 100,
				102, 104, 107, 109, 112, 115, 118, 121, 123, 125, 126, 127, 127,
				127, 127, 127, 126, 125, 124, 121, 119, 116, 113, 109, 105, 102,
				98, 95, 92, 89, 87, 84, 81, 79, 77, 76, 75, 74, 73, 72, 70, 69,
				68, 67, 67, 67, 68, 68, 68, 69, 69, 69, 69, 69, 69, 69, 70, 71,
				72, 73, 73, 74, 74, 75, 75, 75, 75, 75, 75, 74, 74, 73, 73, 73,
				73, 72, 72, 72, 71, 71, 71, 71, 71, 71, 71, 70, 70, 70, 69, 69,
				69, 69, 69, 70, 70, 70, 69, 68, 68, 67, 67, 67, 67, 66, 66, 66,
				65, 65, 65, 65, 65, 65, 65, 65, 64, 64, 63, 63, 64, 64, 65, 65,
				65, 65, 65, 65, 65, 64, 64, 64, 64, 64, 64, 64, 64, 65, 65, 65,
				66, 67, 68, 69, 71, 72, 73 };
//array of pointers to signal tables
const uint8_t *SIGNALS[] = { sinewave, squarewave, trianglewave, sawtoothwave,
		rewsawtoothwave, ECG };
...
void Menu_Update(uint8_t on) {
	...
	if ((SG.mode == 0) || (SG.mode == 1) || (SG.mode == 2) || (SG.mode == 3)
			|| (SG.mode == 4) || (SG.mode == 5)) {
		CopyStringtoLCD(CLR, 0, 1);
		LCDGotoXY(0, 1);
...
//frequency decrement
	...
	if (bit_is_clear(BPIN, START)) {
		if (SG.mode != 6) {
			...
			SG.freq = (((uint32_t) (SG.fr3) << 16) | ((uint32_t) (SG.fr2) << 8)
					| ((uint32_t) (SG.fr1)));
 ...
 */
void static inline Signal_OUT(const uint8_t *signal, uint8_t ad2, uint8_t ad1,
		uint8_t ad0) {
		...
		if (SG.flag == 1) {
			...
			if (SG.mode == 7) {
				...
				Signal_OUT(SIGNALS[SG.mode],
						...
						(uint8_t) ((uint32_t) SG.acc >> 8), (uint8_t) SG.acc);
				//set signal level to 0
				R2RPORT = 0x00;
				//display generator OFF
				Menu_Update(SG.ON);
